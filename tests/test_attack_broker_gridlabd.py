...
def test_gridlabd_attack_scheduling(model_path, setup_teardown_run_file):
    """
    Tests that the GridLab-D attack scheduling logic correctly injects the player object.
    """
    attack_id = "5"
    start_time = "12:00:00"
    end_time = "18:00:00"
    ...
    with open(run_file, "r") as f:
        ...
        assert 'property "Market_1.max_capacity_reference_bid_quantity";' in content
    ...
    with open(player_file, "r") as f:
        content = f.read()
        assert "# Market_1.max_capacity_reference_bid_quantity" in content
        assert "2009-07-21 11:59:59 ,250" in content
        assert "2009-07-21 12:00:00 ,100" in content
        assert "2009-07-21 18:00:00 ,250" in content
